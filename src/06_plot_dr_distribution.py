...
CATEGORY_ORDER: list[str] = [
    ...
    "spores, germinated spores and colonies",
    "spores, germinated spores and divided",
    ...
    "microcolonies",
    "occasionally spores, occasionally germinated, microcolonies",
    "some spores, some germinated, microcolonies",
